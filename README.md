...
* [steam-user](https://github.com/DoctorMcKay/node-steam-user) ⭐ 1,118 | 🐛 65 | 🌐 JavaScript | 📅 2025-12-04 - Feature-rich easy-to-use Steam client.
...
* [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 77 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-31 - A Node.js wrapper for Steamworks SDK.
...
* [steamcommunity](https://github.com/DoctorMcKay/node-steamcommunity) ⭐ 579 | 🐛 48 | 🌐 JavaScript | 📅 2026-07-13 - Interact with steamcommunity.com. Also allows to confirm trade offers.
...
* [steamid](https://github.com/DoctorMcKay/node-steamid) ⭐ 75 | 🐛 1 | 🌐 JavaScript | 📅 2024-10-20 - SteamID usage and conversion made easy.
...
* [SteamKit2](https://github.com/SteamRE/SteamKit) ⭐ 3,176 | 🐛 38 | 🌐 C# | 📅 2026-09-01 - .NET library designed to interoperate with Valve's Steam network.
...
* [go-steam](https://github.com/Philipp15b/go-steam) ⭐ 433 | 🐛 38 | 🌐 Go | 📅 2024-03-13 - Steam's protocol in Go.
...
* [aiosteampy](https://github.com/somespecialone/aiosteampy) ⭐ 106 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - Trade and interact with Steam market, WebAPI, SteamGuard.
...
* [steamguard-cli](https://github.com/dyc3/steamguard-cli) ⭐ 1,036 | 🐛 21 | 🌐 Rust | 📅 2026-09-02 - Command-line utility for generating Steam 2FA codes and managing Steam confirmations.

## Resources

### General

* [Steam Internal WebAPI Documentation by Revadike](https://github.com/Revadike/UnofficialSteamWebAPI) ⭐ 643 | 🐛 2 | 🌐 HTML | 📅 2022-03-26
...
* [SteamDesktopAuthenticator](https://github.com/Jessecar96/SteamDesktopAuthenticator) ⭐ 3,812 | 🐛 317 | 🌐 C# | 📅 2024-10-20 - Desktop implementation of Steam's mobile authenticator app.
* [NetHook2](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHook2) ⭐ 3,176 | 🐛 38 | 🌐 C# | 📅 2026-09-01 - Intercept Steam client's network messages.
* [NetHook2 Analyzer](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHookAnalyzer2) ⭐ 3,176 | 🐛 38 | 🌐 C# | 📅 2026-09-01 - Inspect messages dumped by NetHook2.
