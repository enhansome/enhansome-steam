...
* [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 74 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - A Node.js wrapper for Steamworks SDK.
...
* [steamapi](https://github.com/lloti/node-steamapi) ⭐ 197 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-01 - A nice Steam API wrapper.
...
* [steam-inventory-api-ng](https://github.com/itsjfx/node-steam-inventory-api-ng) ⭐ 5 | 🐛 2 | 🌐 JavaScript | 📅 2025-05-28 - A Steam Inventory API wrapper with advanced features such as retries and proxy support.

#### Game Interaction

* [dota2](https://github.com/RJacksonm1/node-dota2) ⚠️ Archived - Interact directly with Dota 2 game coordinator.
* [csgo](https://github.com/joshuaferrara/node-csgo) ⭐ 465 | 🐛 9 | 🌐 JavaScript | 📅 2023-09-27 - Interact directly with CS:GO game coordinator.
* [tf2](https://github.com/DoctorMcKay/node-tf2) ⭐ 62 | 🐛 13 | 🌐 JavaScript | 📅 2024-03-12 - Interact directly with TF2 game coordinator.
...
* [passport-steam](https://github.com/liamcurry/passport-steam) ⭐ 358 | 🐛 23 | 🌐 JavaScript | 📅 2026-04-02 - Steam (OpenID) authentication strategy for Passport and Node.js.
...
* [steamid](https://github.com/DoctorMcKay/node-steamid) ⭐ 74 | 🐛 1 | 🌐 JavaScript | 📅 2024-10-20 - SteamID usage and conversion made easy.
...
* [SteamKit2](https://github.com/SteamRE/SteamKit) ⭐ 3,159 | 🐛 37 | 🌐 C# | 📅 2026-08-01 - .NET library designed to interoperate with Valve's Steam network.
...
* [BackpackLogin](https://github.com/igeligel/BackpackLogin) ⭐ 6 | 🐛 1 | 🌐 C# | 📅 2017-04-23 - A .NET Standard library for logging into backpack.tf using Steam credentials.
...
* [SteamCommunity](https://github.com/waylaidwanderer/PHP-SteamCommunity) ⭐ 80 | 🐛 25 | 🌐 PHP | 📅 2017-10-25 - A PHP library for interacting with the Steam Community website.
...
* [go-steam](https://github.com/Philipp15b/go-steam) ⭐ 432 | 🐛 38 | 🌐 Go | 📅 2024-03-13 - Steam's protocol in Go.
...
* [dota2](https://github.com/ValvePython/dota2) ⭐ 222 | 🐛 33 | 🌐 Python | 📅 2023-03-02 - Python module for interacting with Dota 2's Game Coordinator.
...
* [steamguard-cli](https://github.com/dyc3/steamguard-cli) ⭐ 1,023 | 🐛 21 | 🌐 Rust | 📅 2026-07-29 - Command-line utility for generating Steam 2FA codes and managing Steam confirmations.
...
* [Steam Internal WebAPI Documentation by Revadike](https://github.com/Revadike/UnofficialSteamWebAPI) ⭐ 640 | 🐛 2 | 🌐 HTML | 📅 2022-03-26
...
* [In-depth Steam Bot Guide with Node.js](https://github.com/andrewda/node-steam-guide) ⭐ 711 | 🐛 29 | 🌐 JavaScript | 📅 2024-08-05
...
* [SteamDesktopAuthenticator](https://github.com/Jessecar96/SteamDesktopAuthenticator) ⭐ 3,810 | 🐛 318 | 🌐 C# | 📅 2024-10-20 - Desktop implementation of Steam's mobile authenticator app.
* [NetHook2](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHook2) ⭐ 3,159 | 🐛 37 | 🌐 C# | 📅 2026-08-01 - Intercept Steam client's network messages.
* [NetHook2 Analyzer](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHookAnalyzer2) ⭐ 3,159 | 🐛 37 | 🌐 C# | 📅 2026-08-01 - Inspect messages dumped by NetHook2.
