...
* [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 78 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-31 - A Node.js wrapper for Steamworks SDK.
...
* [SteamKit2](https://github.com/SteamRE/SteamKit) ⭐ 3,181 | 🐛 38 | 🌐 C# | 📅 2026-09-01 - .NET library designed to interoperate with Valve's Steam network.
...
* [steamguard-cli](https://github.com/dyc3/steamguard-cli) ⭐ 1,037 | 🐛 21 | 🌐 Rust | 📅 2026-09-02 - Command-line utility for generating Steam 2FA codes and managing Steam confirmations.
...
* [NetHook2](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHook2) ⭐ 3,181 | 🐛 38 | 🌐 C# | 📅 2026-09-01 - Intercept Steam client's network messages.
* [NetHook2 Analyzer](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHookAnalyzer2) ⭐ 3,181 | 🐛 38 | 🌐 C# | 📅 2026-09-01 - Inspect messages dumped by NetHook2.
