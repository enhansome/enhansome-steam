...
* [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 80 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-23 - A Node.js wrapper for Steamworks SDK.
...
* [SteamKit2](https://github.com/SteamRE/SteamKit) ⭐ 3,200 | 🐛 37 | 🌐 C# | 📅 2026-09-16 - .NET library designed to interoperate with Valve's Steam network.
...
* [dota2](https://github.com/ValvePython/dota2) ⭐ 224 | 🐛 33 | 🌐 Python | 📅 2023-03-02 - Python module for interacting with Dota 2's Game Coordinator.
* [csgo](https://github.com/ValvePython/csgo) ⭐ 132 | 🐛 16 | 🌐 Python | 📅 2021-02-03 - Python module for interacting with CSGO's Game Coordinator.
...
* [steamguard-cli](https://github.com/dyc3/steamguard-cli) ⭐ 1,045 | 🐛 23 | 🌐 Rust | 📅 2026-09-22 - Command-line utility for generating Steam 2FA codes and managing Steam confirmations.
...
* [SteamDesktopAuthenticator](https://github.com/Jessecar96/SteamDesktopAuthenticator) ⭐ 3,821 | 🐛 318 | 🌐 C# | 📅 2024-10-20 - Desktop implementation of Steam's mobile authenticator app.
* [NetHook2](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHook2) ⭐ 3,200 | 🐛 37 | 🌐 C# | 📅 2026-09-16 - Intercept Steam client's network messages.
* [NetHook2 Analyzer](https://github.com/SteamRE/SteamKit/tree/master/Resources/NetHookAnalyzer2) ⭐ 3,200 | 🐛 37 | 🌐 C# | 📅 2026-09-16 - Inspect messages dumped by NetHook2.
